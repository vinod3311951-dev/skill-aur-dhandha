...
const checks=[
  ['src/navigation-runtime.ts',['popstate','history.back','history.forward','skillDepth','data-history-forward','replay']],
  ['src/choice-experience.ts',['5-step practice roadmap','Research centred on','Compare with another choice','open-paisa-business','open-market','open-learn','open-government-help']],
