...
assert(r.fixedMonthly===3250,'fixed monthly arithmetic');
assert(r.monthly===5750,'monthly cost arithmetic');
assert(r.surplus===4250,'operating surplus arithmetic');
...
assert(r.breakEvenUnits===44,'break-even rounding');
assert(Math.abs(r.recoveryMonths-(6000/4250))<1e-9,'startup recovery');
