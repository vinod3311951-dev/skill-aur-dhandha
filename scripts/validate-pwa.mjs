...
const required=['index.html','public/manifest.webmanifest','public/sw.js','public/icon.svg','public/icon-192.png','public/icon-512.png'];
const failures=[];
...
console.log('PWA contract PASS: manifest, icons, registration and offline shell are present.');
