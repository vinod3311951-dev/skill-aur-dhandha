...
for(const removed of ['/src/self-marketing.ts','/src/research-lens.ts','/src/home-business-tips.ts','/src/affiliate-readiness.ts']){
  if(index.includes(removed))failures.push('global injector still enabled: '+removed);
}
for(const token of ['5-step plan for','What can I do now?','Research centred on','Save this choice on this device','data-flow-next','data-flow-back']){
...
if(!choice.includes('data-flow-skip'))failures.push('optional research skip control missing');
if(choice.includes("key==='compare'")||choice.includes('data-choice-compare-open'))failures.push('comparison stage must stay removed');
...
console.log('Choice journey contract PASS: simplified journey with optional research and focused Paisa/Market shortcuts.');
