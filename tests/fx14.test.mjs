...
test("presentation identity hooks exist",()=>{const a=read("src/app.js"),h=read("index.html");assert.match(a,/showRestore/);assert.match(h,/CD-SFX-011-color-bloom-v1\.wav/);assert.match(a,/renderMap/);assert.match(a,/reducedMotion/)});
